        ...
        <div className="container mx-auto flex justify-between py-4">
          ...
          <AnimationScroll direction="up">
            <div className="h-[300px] lg:h-[450px] w-full mx-auto relative overflow-hidden">
              <ImageSlider images={['/images/projects/ismail/ismail-1.png','/images/projects/ismail/ismail-2.png','/images/projects/ismail/ismail-3.png','/images/projects/ismail/ismail-4.png','/images/projects/ismail/ismail-5.png','/images/projects/ismail/ismail-6.png']} />
            </div>
          </AnimationScroll>
        </div>
      </section>
      ...
      <section className='project_desc mt-20'>
        <div className="container  mx-auto flex flex-col gap-6 justify-between">
          ...
          <div className="flex gap-4 xl:gap-6 col-span-2">
            ...
            <div>
              <AnimationScroll direction="up">
                <h2 className="text-3xl md:text-5xl text-golden ">Aronnok Ismail Garden</h2>
                <p className="text-lg font-medium">Plot – 1800/E, Road 39, Block - I (Ext.), Bashundhara R/A </p>
              </AnimationScroll>
            </div>
              ...
              <div className="specs">
                ...
                <div className="flex flex-col md:flex-row justify-between mt-4 max-w-[850px] text-lg ">
                  ...
                  <ul className='list-disc pl-4 '>
                    ...
                    <li><span className='font-medium'>Apartment Size :</span> 1850 SQFT</li>
                  </ul>


                  <ul className='list-disc pl-4 '>
                    <li><span className='font-medium'>Number of Apartments :</span> 09</li>
                    <li><span className='font-medium'>Number of Parking :</span> 09</li>
                    <li><span className='font-medium'>Number of Floors :</span> G+09</li>
                    <li><span className='font-medium'>Handover date :</span> Dec 2026</li>
                  </ul>
