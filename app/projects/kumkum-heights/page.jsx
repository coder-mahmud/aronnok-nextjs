      ...
      {/* <section className='sec_hero'>
        <div className="container  mx-auto flex justify-between">
          <div className="h-[350px] lg:h-[500px] hero_wrap relative w-full ">
            <Image className="w-full h-full" src="/images/kumkum-hero.jpg" height={737} width={1723} alt="about image" />
            <h1 className="about_hero_text absolute bottom-14 left-4  lg:left-14 font-medium text-3xl lg:text-5xl text-white z-20">
              
              <AnimationScroll direction="up">Aronnok Kumkum Heights</AnimationScroll>
        ...
        <div className="container mx-auto flex justify-between py-4">
          ...
          <AnimationScroll direction="up">
            <div className="h-[300px] lg:h-[450px] w-full mx-auto relative overflow-hidden">
              <ImageSlider images={['/images/projects/kumkum/1.jpeg','/images/projects/kumkum/2.jpeg','/images/projects/kumkum/3.jpeg','/images/projects/kumkum/4.jpeg','/images/projects/kumkum/5.jpeg']} />
            </div>
          </AnimationScroll>
        </div>
      </section>
      ...
      <section className='project_desc mt-20'>
        <div className="container  mx-auto flex flex-col gap-6 justify-between">
          ...
          <div className="flex gap-4 xl:gap-6 col-span-2">
            ...
            <div>
              <AnimationScroll direction="up">
                <h2 className="text-3xl md:text-5xl text-golden ">Aronnok Kumkum Heights</h2>
                <p className="text-lg font-medium">Plot – 14, Road 06, Sector 02, Block - L, Aftabnagar </p>
              </AnimationScroll>
            </div>
              ...
              <div className="specs">
                ...
                <div className="flex flex-col md:flex-row justify-between mt-4 max-w-[850px] text-lg ">
                  ...
                  <ul className='list-disc pl-4 '>
                    ...
                    <li><span className='font-medium'>Front Road :</span> 25 Feet (South)</li>
                    <li><span className='font-medium'>Land Size :</span> 03.50 Katha</li>
                    <li><span className='font-medium'>Apartment Size :</span> 1680 SQFT</li>
                  </ul>


                  <ul className='list-disc pl-4 '>
                    <li><span className='font-medium'>Number of Apartments :</span> 07</li>
                    <li><span className='font-medium'>Number of Parking :</span> 07</li>
                    <li><span className='font-medium'>Number of Floors :</span> G+07</li>
