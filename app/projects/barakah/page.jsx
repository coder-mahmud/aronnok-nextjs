        ...
        <div className="container mx-auto flex justify-between py-4">
          ...
          <AnimationScroll direction="up">
            <div className="h-[300px] lg:h-[450px] w-full mx-auto relative overflow-hidden">
              <ImageSlider images={['/images/projects/barakah/1.png','/images/projects/barakah/2.png','/images/projects/barakah/3.png','/images/projects/barakah/4.png']} />
            </div>
          </AnimationScroll>
        </div>
      </section>
      ...
      <section className='project_desc mt-20'>
        <div className="container  mx-auto flex flex-col gap-6 justify-between">
          ...
          <div className="flex gap-4 xl:gap-6 col-span-2">
            ...
            <div>
              <AnimationScroll direction="up">
                <h2 className="text-3xl md:text-5xl text-golden ">Aronnok Barakah</h2>
                <p className="text-lg font-medium">Sector 14, Road 502A, Plot 005, Jolshiri Abashon</p>
              </AnimationScroll>
            </div>
              ...
              <div className="specs">
                ...
                <div className="flex flex-col md:flex-row justify-between mt-4 max-w-[850px] text-lg ">
                  ...
                  <ul className='list-disc pl-4 '>
                    ...
                    <li><span className='font-medium'>Front Road :</span> 40 Feet (North)</li>
                  ...
                  <ul className='list-disc pl-4 '>
                    ...
                    <li><span className='font-medium'>Handover date :</span> May 2029</li>
                  </ul>
